...
ESX.RegisterCommand('setjob2', {'founder','cofounder','admin'}, function(xPlayer, args, showError)
	...
	{name = 'grade2', help = TranslateCap('command_setjob2_grade'), type = 'number'}
}})
...
ESX.RegisterCommand('job2', {"user", "founder", "cofounder", "admin", "mod", "streamer"}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getJob2().name.. "^0 - ^5".. xPlayer.getJob2().grade_label .. "^0")
end, true)

ESX.RegisterCommand('info', {"user", "founder", "cofounder", "admin", "mod", "helper", "streamer"}, function(xPlayer, args, showError)
	local job = xPlayer.getJob().name
	local jobgrade = xPlayer.getJob().grade_name
	local job2 = xPlayer.getJob2().name
	local job2grade = xPlayer.getJob2().grade_name
	print("^2ID : ^5"..xPlayer.source.." ^0| ^2Name:^5"..xPlayer.getName().." ^0 | ^2Group:^5"..xPlayer.getGroup().."^0 | ^2Job:^5".. job.."^0".."^0 | ^2Job2:^5".. job2.."^0") 
end, true)
...
ESX.RegisterCommand('coords', {"founder", "cofounder", "admin", "mod", "helper"}, function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:copyCoords', '3')
	xPlayer.showNotification( "Coordinate vec3 copiate con successo!")
end, false)

ESX.RegisterCommand('coords4', {"founder", "cofounder", "admin", "mod", "helper"}, function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:copyCoords', '4')
	xPlayer.showNotification( "Coordinate vec4 copiate con successo!")
end, false)