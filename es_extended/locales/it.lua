Locales['it'] = {
  ...
  ['command_setjob2'] = 'Setta lavoro ad un giocatore',
  ['command_setjob2_job'] = 'Nome',
  ['command_setjob2_grade'] = 'Grado lavoro',
  ['command_setjob2_invalid'] = 'Il lavoro, grado o entrambi sono errati',
